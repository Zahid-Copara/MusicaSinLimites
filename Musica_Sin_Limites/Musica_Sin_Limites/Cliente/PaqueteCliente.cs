...
namespace Cliente
{
    public class PaqueteCliente
    {
        ...
        public PaqueteCliente(string comando, string contenido)
        {
            Comando = comando;
            Contenido = contenido;
        }
        ...
        public PaqueteCliente(string datos)
        {
        ...
        //Metodo accesible sin necesidad de instanciar el objeto paquete cliente, implicito ya que esta definido de manera de usuario, operador
        ...
        public static implicit operator string(PaqueteCliente paquete)
        {
